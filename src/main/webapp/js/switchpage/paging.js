...
(function (root, factory) {
    ...
    Paging.prototype = {
        ...
        bindToolbar: function () {
            var _this = this;
            var html = $('<li class="ui-paging-toolbar"><input type="text" class="ui-paging-count"/><a href="javascript:void(0)">跳转</a></li><li style="border: none;position: absolute;right: 100px;">共 ' + this.count + ' 条记录</li>');
